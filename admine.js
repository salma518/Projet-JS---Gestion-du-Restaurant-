...
let editingDishId = null; //stocker l'ID du plat 
...
function displayDishes(dishes) {
    ...
    dishes.forEach(dish => {
        ...
        `;
        adminList.appendChild(item); // Ajoute l'élément à la liste
    });
...
function resetForm() {
    ...
    document.getElementById('submit-dish').textContent = 'Ajouter Plat'; 
}
