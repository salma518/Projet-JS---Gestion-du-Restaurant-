...
function loadProducts() {
    ...
    xhr.send(); //récupérer les produits
}
...
function addCartEventListeners() {
    ...
    addToCartButtons.forEach((button, index) => {
        button.addEventListener('click', () => {
            ...
            const existingItem = cartItems.find(cartItem => cartItem.name === item.name); //se trouve ou pas
...
// Met à jour la liste des articles dans le panier
    ...
    function removeItemFromCart(index) {
        ...
        totalAmount -= removedItem.price * removedItem.quantity;  // Mise à jour $
...
document.getElementById('btn').onclick = function(){
    if(localStorage.getItem('userconn') != null){
        Swal.fire({
        ...
        Swal.fire({
            title: "La Commande n'est pas passé  !",
